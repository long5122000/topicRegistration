...
const InternshipAssessmentAddNew = () => {
  ...
  const handleCreateAppointment = async (values: values): Promise<void> => {
    ...
    try {
      await addDoc(colRef, {
        name: "Nộp phiếu đánh giá thực tập của cán bộ hướng dẫn tại cơ sở",
        desc: content,
        startDate: startDate,
        endDate: endDate,
          ...
          <Field>
            <Label>
              ...
              <h3 className="text-xl text-red-400">
                Nộp phiếu đánh giá thực tập của cán bộ hướng dẫn tại cơ sở
              </h3>
            </Label>
          </Field>
          <Field>
...
export default InternshipAssessmentAddNew;
